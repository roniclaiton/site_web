...
def get_departement_by_code(code):
    return next((dept for dept in departements if dept['code'] == code), None)

# Dans departements.py
def get_departements_by_region(region):
    # Pour une future utilisation si vous voulez filtrer par région
    pass

def search_departements(query):
    # Pour rechercher des départements par nom
    return [dept for dept in departements if query.lower() in dept['nom'].lower()]